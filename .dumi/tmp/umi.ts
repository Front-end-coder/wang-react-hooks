...
import 'D:/leetcode/wang-react-hooks/.dumi/global.css';
import { getPluginManager as getDumiPluginManager } from './core/plugin';
import { setPluginManager as setDumiPluginManager } from 'D:/leetcode/wang-react-hooks/node_modules/.pnpm/dumi@2.4.18_@babel+core@7.26.9_@types+node@22.13.5_eslint@8.57.1_jest@29.7.0_prettier@2.8.8_r_mri3hv5on3q6hiutw435uoveqi/node_modules/dumi/dist/client/theme-api/utils.js';
import { renderClient } from 'D:/leetcode/wang-react-hooks/node_modules/.pnpm/@umijs+renderer-react@4.4.5_react-dom@18.3.1_react@18.3.1/node_modules/@umijs/renderer-react';
...
const publicPath = "/wang-react-hooks/";
...
async function render() {
  ...
  const basename = contextOpts.basename || '/wang-react-hooks/';
